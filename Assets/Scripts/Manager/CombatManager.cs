...
public class CombatManager : MonoBehaviour
{
    ...
    private IEnumerator PerformAttack(Fighter attacker, MoveData move, bool isPlayerAttack)
    {
        ...
        // Attack-Step: vor der Animation auf Zieldistanz lerpen (blockierend)
        if (move.attackStepDistance > 0f)
            yield return attacker.StepToDistance(defender.transform, move.attackStepDistance, move.attackStepSpeed);
